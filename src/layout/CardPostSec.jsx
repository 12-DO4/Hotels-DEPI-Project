      ...
      <div className="card rounded-4 overflow-hidden border-0 shadow-lg">
        <div className="card-img-holder p-rel">
          ...
          <div className="badges">
            <span className="adv-badge d-inline-block text-white prm-bg p-2">Adventure</span>
          </div>
        </div>
        <div className="card-body p-4">
          ...
          <Link to={ `/postPreview/${post[0].id}` } className="btn btn-secondary mt-3">Explore More</Link>
        </div>
      </div>
    </div>
  )
