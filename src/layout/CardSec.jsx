...
import { travelData } from "../components/TourSec";
      ...
      <div className="card rounded-4 overflow-hidden border-0 shadow-lg">
        <div className="card-img-holder p-rel">
          <div className="img-part">
            <img src={"/assets/imgs/" + travel[0].imgSrc} className="card-img-top" alt={ travel[0].title + " img"} />
          </div>
        ...
        <div className="card-body p-3">
          ...
          <div className="row time align-items-center">
            ...
            <div className="col-6 text-end">
              <Link className="btn btn-secondary" to={`/tourDetails/${travel[0].id}`}>Explore More</Link>
            </div>
          </div>
        </div>
      </div>
